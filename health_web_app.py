# -*- coding: utf-8 -*-
"""
Created on Fri Jun 14 23:27:58 2024
    ...
    if st.button('Diabetes Test Result'):
        ...
        try:
            ...
            if any(x == '' for x in user_input):
                diab_diagnosis = 'Please fill in all fields'
            else:
...
if (selected == 'Heart Disease Prediction'):
    ...
    with col1:
        thal = st.text_input('thal: 0 = normal; 1 = fixed defect; 2 = reversale defect')
    ...
    if st.button('Heart Disease Test Result'):
        ...
        try:
            ...
            # check for any empty inputs
            if any(x == '' for x in user_input):
                heart_diagnosis = 'Please fill in all fields'
            else:
                # convert inputs to float
                user_input = [float(x) for x in user_input]
...
if (selected == 'Parkinsons Prediction'):
    ...
    if st.button("Parkinson's' Test Result"):
        ...
        try:
            ...
            # check for any empty inputs
            if any(x == '' for x in user_input):
                parkinsons_diagnosis = 'Please fill in all fields'
            else:
                # convert inputs to float
                user_input = [float(x) for x in user_input]
